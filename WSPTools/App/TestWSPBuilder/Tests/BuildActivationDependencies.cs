...
{
    [TestFixture]
    public class BuildActivationDependencies
    {
        private const string PROJECTNAME = @"BuildActivationDependencies";
        ...
        public void Build()
        {
            ...
            Assert.IsNotNull(manifestHandler.Manifest.ActivationDependencies);
            Assert.AreEqual(manifestHandler.Manifest.ActivationDependencies.Length, 1);

...
namespace WSPBuilderTemplates.Framework.Wizard
{
	/// <summary>
	/// 
	/// </summary>
    [Designer(typeof(WSPBuilderTemplates.Framework.Wizard.WizardPageDesigner))]
	public class WizardPage : Panel
	{
		...
		public int OnCloseFromBack(WizardController wiz)
		{
		...
		public int OnCloseFromNext(WizardController wiz)
		{	
			//Event args thinks that the next pgae will be the one before this one
			PageEventArgs e = new PageEventArgs(wiz.PageIndex +1, wiz.Pages);
			//Tell anybody who listens
		...
		/// </summary>
		/// <param name="wiz">sender</param>
		public void OnShowFromBack(WizardController wiz)
		{
		...
		/// </summary>
		/// <param name="wiz">Sender</param>
		public void OnShowFromNext(WizardController wiz)
		{

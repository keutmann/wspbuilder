...
namespace WSPBuilderTemplates.Framework.Wizard
{
	...
	/// are of the wizard.
	/// </summary>
    [Designer(typeof(WSPBuilderTemplates.Framework.Wizard.WizardDesigner))]
	[ToolboxItem(true)]
    [ToolboxBitmap(typeof(WSPBuilderTemplates.Framework.Wizard.WizardController))]
	public class WizardController : System.Windows.Forms.UserControl
	{

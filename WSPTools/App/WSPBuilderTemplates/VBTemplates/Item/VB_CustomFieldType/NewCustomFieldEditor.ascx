<%@ Control Language="VB" Inherits="$DefaultNamespace$.$rootname$FieldEditor, $AssemblyName$, Version=$AssemblyVersion$, Culture=neutral, PublicKeyToken=$PublicKeyToken$"    compilationMode="Always" %>

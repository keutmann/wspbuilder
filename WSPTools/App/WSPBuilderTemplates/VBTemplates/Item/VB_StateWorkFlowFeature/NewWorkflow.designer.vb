...
#Region "Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.onWorkflowActivated1.SetBinding(Microsoft.SharePoint.WorkflowActions.OnWorkflowActivated.WorkflowPropertiesProperty, (DirectCast((activitybind1), System.Workflow.ComponentModel.ActivityBind)))
            ' 
            ...
            Me.Workflow1InitialState.Name = "$rootname$InitialState"
            ' 
            ' Workflow1
            ' 
            ...
            Me.InitialStateName = "$rootname$InitialState"
            Me.Name = "$rootname$"
...
#End Region
        ...
        Private eventDrivenActivity1 As EventDrivenActivity
        Private onWorkflowActivated1 As Microsoft.SharePoint.WorkflowActions.OnWorkflowActivated
        Private Workflow1InitialState As StateActivity
